...
|---|---|---|---:|---:|---|---|
| fccPt_SOC | fp32 | cpu_fast | 1 | 24.305 | PASS | no |
| fccPt_SOC | fp32 | cpu_fast | 2 | 24.088 | PASS | no |
| fccPt_SOC | fp32 | cpu_fast | 4 | 24.381 | PASS | no |
| fccPt_SOC | fp32 | cpu_fast | 8 | 25.976 | PASS | no |
...
| GPU row | CPU reference | S_moments | S_transport | S_whole |
|---|---|---:|---:|---:|
| fccPt_SOC_b32a6e11ea33ea0c | fccPt_SOC_59694fd3f47b40c7 | 24.359737514925182 | 11.423549172291317 | 10.627062567425561 |
