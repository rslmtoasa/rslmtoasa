    ...
    do ia_glob=start_atom, end_atom
      ...
      do i=1, this%en%channels_ldos+10
        do j=1, 9
          ...
          !dosia(ia,i) = dosia(ia,i) - aimag(this%green%g0(j, j, i, ia)+this%green%g0(j+9, j+9, i, ia))/pi
          !dosial(ia,j,i) = -aimag(this%green%g0(j, j, i, ia))/pi
          !dosial(ia,j+9,i) = -aimag(this%green%g0(j+9, j+9, i, ia))/pi
        end do
