   ...
   module subroutine fourier_transform_gbt_array(this, array4d, k_vec, mk_result)
      ...
      do isite = 1, n_sites
         ...
         do ineigh = 1, nr
            ...
            ! Scalar and longitudinal exchange are Bloch-summed at k. Use the
            ! same direct-coordinate neighbor vector convention as
            ! calculate_structure_factors for the transverse spiral phase.
            sf0 = structure_factors(ineigh, ntype_i)
            if (ineigh == 1) then
               r_direct = 0.0_rp
            else
