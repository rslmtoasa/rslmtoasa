...
contains
   ...
   subroutine report(this)
      ...
      call g_logger%info('Calculation finished.', __FILE__, __LINE__)
      !===========================================================================
      !                      Total Energy
      !===========================================================================
      if (rank == 0) then
         totene = 0.0_RP
         do ia = 1, this%lattice%nrec
            totene = totene + this%symbolic_atom(ia)%potential%etot
         end do
         fmt = "(f16.8)"
         call g_logger%info('Total energy of system: '//real2str(totene, fmt)//' Ry', __FILE__, __LINE__)
      end if
