logical :: hoh, flatten_hoh, hubbard_u_outside_hoh, local_axis, orb_pol, v_a, v_b
...
namelist /hamiltonian/ hoh, flatten_hoh, hubbard_u_outside_hoh, local_axis, orb_pol, v_alpha, v_beta, js_alpha, jl_alpha, velocity_scale, q_ss, theta_ss, uj_orb, hubbard_u, hubbard_j, hubbard_v, &
